...
bool Mesh::CreateSquare(Direct3D* renderer, const char* identifier)
{
	...
	verts[1].position = Vector3(-1.0f, .0f, 0.0f);
	verts[1].colour = Color(0.0f, 1.0f, 1.0f, 1.0f);

	verts[2].position = Vector3(0.0f, -1.0f, 0.0f);
	verts[2].colour = Color(0.0f, 0.0f, 1.0f, 1.0f);

	verts[3].position = Vector3(0.0f, 0.0f, 0.0f);
	verts[3].colour = Color(0.0f, 1.0f, 1.0f, 1.0f);
